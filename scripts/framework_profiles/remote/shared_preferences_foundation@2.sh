#!/bin/bash
# =============================================
#   Profile: shared_preferences_foundation (远程依赖，传递依赖)
#   版本: 2.x (Swift, darwin/SPM 结构)
#   iOS 源文件:
#     darwin/shared_preferences_foundation/Sources/shared_preferences_foundation/
...
PROFILE_NAME="shared_preferences_foundation"
PROFILE_VERSION="2"
...
profile_apply() {
    ...
    local src_dir
    src_dir=$(bt_find_src_dir "$plugin_dir" "shared_preferences_foundation")
    [[ -z "$src_dir" ]] && return 1
