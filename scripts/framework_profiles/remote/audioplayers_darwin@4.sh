...
#   Version: 4.x (Swift + ObjC bridge, ios/Classes 源码结构)
#   说明: v4 与 v5 原生结构一致（darwin/Classes/ 下 ObjC 桥 AudioplayersDarwinPlugin.m
#         + SwiftAudioplayersDarwinPlugin.swift + WrappedMediaPlayer/AudioContext/Utils），
#         v6 才迁移到 SPM 并去掉 ObjC 桥。故本 profile 复用 @5 的处理逻辑，仅主版本不同。
# =============================================
