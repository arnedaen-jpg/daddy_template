...
class ObfuscatorConfig {
  ...
  List<String> get sensitivePatterns {
    ...
    switch (projectName) {
      case 'dq':
        // 斗球/直播：基线来自 zeus tx，并参考 acfun/oio/nnrj/bili/tiktok 等
        // 直播·IM·礼物·竞猜·钱包·埋点 补充清单（与 compat_dq 资源中和词对齐）
        return [
          ...common,
          // --- 来自 zeus tx（壳入口基线）---
          'movie',
          ...
          'captcha',
          'upload',
          // --- 直播 / 主播 / 弹幕（acfun·oio·tiktok + dq 资源指纹）---
          'anchor',
          'zhibo',
          'barrage',
          'danmu',
